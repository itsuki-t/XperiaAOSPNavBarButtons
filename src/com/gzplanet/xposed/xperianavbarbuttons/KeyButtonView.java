...
public class KeyButtonView extends ImageView {
	...
	public KeyButtonView(Context context, AttributeSet attrs, int defStyle) {
		...
		TypedArray a = context.obtainStyledAttributes(attrs,
				R.styleable.KeyButtonView, defStyle, 0);

		mCode = a.getInteger(R.styleable.KeyButtonView_keyCode, 0);

		mSupportsLongpress = a.getBoolean(R.styleable.KeyButtonView_keyRepeat,
				true);
	...
	public KeyButtonView(final Context context, final int code,
			final boolean supportsLongpress, final Drawable glowBg) {
		super(context);
	...
	public void setGlowScale(float x) {
		...
		if (GLOW_MAX_SCALE_FACTOR <= 1.0f) {
			...
			invalidateGlobalRegion(this, new RectF(getLeft() - rx, getTop()
					- ry, getRight() + rx, getBottom() + ry));
			...
			if (pressed != isPressed()) {
				...
				if (pressed) {
					...
					as.playTogether(ObjectAnimator.ofFloat(this, "glowAlpha",
							...
							ObjectAnimator.ofFloat(this, "drawingAlpha",
									BUTTON_QUIESCENT_ALPHA));
					as.setDuration(500);
				}
				as.start();
			}
